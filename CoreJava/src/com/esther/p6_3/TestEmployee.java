...
public class TestEmployee {
	...
	public static Vector<Employee> main1() {
		...
		Employee e1=new Employee(101, "Esther", "Rani");
		Employee e2=new Employee(102, "Sujana", "Koreboina");
		Employee e3=new Employee(103, "Benny", "Zachariah");
